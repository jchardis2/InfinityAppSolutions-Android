...
public class VideoProvider {
	...
	protected String parseUrl(String urlString) {
		InputStream is = null;
		try {
	...
	public static List<MediaInfo> buildMedia(String url) throws JSONException {
		...
		IASGson<ArrayList<VideoBean>> gson = new IASGson<ArrayList<VideoBean>>();
		String gsonTerm = new VideoProvider().parseUrl(url);
		Type type = new TypeToken<ArrayList<VideoBean>>() {
		}.getType();
		System.out.println(type);
		ArrayList<VideoBean> videoList = gson.fromGson(gsonTerm, type);
		for (VideoBean videoBean : videoList) {
			mediaList.add(buildMediaInfo(videoBean.getName(),
					"Infinity App Solutions", videoBean.getFile(),
					"http://" + videoBean.getUrl(),
					"http://home.infinityappsolutions.com:8080/pb.png",
					"http://home.infinityappsolutions.com:8080/pb.png"));
		}
	...
	// String bigImageurl = getThumbPrefix() +
